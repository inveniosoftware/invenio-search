...
Invenio-Search could always use more documentation, whether as part of the
official Invenio-Search docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/inveniosoftware/invenio-search/issues.
...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check
   https://github.com/inveniosoftware/invenio-search/actions?query=event%3Apull_request
